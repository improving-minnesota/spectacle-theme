...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polished__ = __webpack_require__(584);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__deep_assign__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images_OPi_logo_svg__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images_OPi_logo_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__images_OPi_logo_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__images_pattern_svg__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__images_pattern_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__images_pattern_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__colors__ = __webpack_require__(86);
...
var defaultColors = {
  primary: __WEBPACK_IMPORTED_MODULE_4__colors__["a" /* OPI_RED */],
  secondary: __WEBPACK_IMPORTED_MODULE_4__colors__["b" /* OPI_BLACK */],
  tertiary: 'white',
  quartenary: 'white'
};
  ...
  return {
    ...
    global: {
      ...
      '.opi-title-slide .spectacle-slide > div:before': {
        ...
        transformOrigin: 0,
        background: 'linear-gradient(65deg, black, ' + __WEBPACK_IMPORTED_MODULE_0_polished__["a" /* lighten */](0.1, __WEBPACK_IMPORTED_MODULE_4__colors__["b" /* OPI_BLACK */]) + ' 75%)'
      },
      '.opi-title-slide .spectacle-slide > div:after': {
        ...
        height: 56,
        width: '100%',
        background: 'url(' + __WEBPACK_IMPORTED_MODULE_2__images_OPi_logo_svg___default.a + ') no-repeat right 10px center / auto 50%'
      },
      '.opi-title-slide .spectacle-slide:before': {},
      '.spectacle-slide': {
        backgroundSize: '200px !important',
        backgroundImage: 'url(' + __WEBPACK_IMPORTED_MODULE_3__images_pattern_svg___default.a + ')'
      },
...
function deepAssign() {
  ...
  return rest.reduce(function (assigned, obj) {
    return Object.keys(obj || {}).reduce(function (nestedAssigned, key) {
      nestedAssigned[key] = Object.assign(nestedAssigned[key] || {}, obj[key] || {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__screen__ = __webpack_require__(273);
...
var createTheme = function createTheme() {
  return {
    screen: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__screen__["a" /* default */])()
  };
};
